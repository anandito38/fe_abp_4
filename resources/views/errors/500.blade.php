<svg id="mainImage_create" data-name="mainImage" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 171.2 81.5">
    ...
    <rect id="c-2" class="changeColor cls-7" x="74.82" y="26.48" width="19.14" height="2.45"
        transform="translate(1.29 -3.65) rotate(2.49)" style="fill: rgb(237, 4, 0);"></rect>
    <path id="c-3" class="changeColor cls-7"
        ...
        transform="translate(1.06 -3.66) rotate(2.49)" style="fill: rgb(237, 4, 0);"></path>
    <polygon id="c-4" class="changeColor cls-8"
        points="82.44 23.89 92.18 24.32 92.59 24.34 92.48 26.84 80.96 26.33 82.44 23.89" style="fill: rgb(237, 4, 0);">
    </polygon>
    ...
    <text id="title" transform="matrix(1 0 0 1 44.7249 78)">500 Internal server error</text>
</svg>
